...
<div class="container">
	<div class="content">
  		<div class="page-header">
		  	<h1 class="center">Update Employee Form</h1>
		</div>
		<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
		  ...
		  <li class="nav-item">
		    <a class="btn btn-warning" href="<?php echo base_url('index.php/main_form'); ?>" ><i class="fa fa-arrow-left"></i> &nbsp; Back to Employee Form</a>
		  </li>
		</ul>
		<br>
					...
					<div class="col-lg-12">
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="row">
									<div class="col-lg-3">
										<label>NIK<? echo $x;?></label>
									</div>
									<div class="col-lg-3">
										<input type="text" name="" value="<?php echo $x;?>">
									</div>
								</div>
								<br>
								<div class="row">
