...
===================================================================
    ...
    Description         : Query Insert Seller to Database Timah
...
class m_tpa_01_query_insert_seller extends CI_Model {
	...
	public function ClearingMemberTable($Code,$calon,$email,$notlp,$jenis_anggota,$akte_pendiri,$akte_perubahan,$domisili_perusahaan,$npwp_perusahaan,$id_kep_seller,$doc_ekspor_timah,$perizinan_instansi,$member_stat,$no_acc,$acc_name,$bank_name,$nib,$idp,$lk,$rfbn,$compro,$domisili,$status_usaha,$address){
		// $concat_code_cm,$n_calon,$email,$notlp,$jenis_anggota,$akte_pendiri,$akte_perubahan,$domisili_perusahaan,$npwp_perusahaan,$id_kep_seller,$doc_ekspor_timah,$perizinan_instansi,$s_calon,$no_acc,$acc_name,$bank_name
		// echo print_r('masuk');
	    ...
	    $id_kep_seller = $db->escape($id_kep_seller);
	    $doc_ekspor_timah = $db->escape($doc_ekspor_timah);
	    ...
	    $rcd_clearing_member_profile = $db->Execute($query_clearig_member_profile);
	    	...
	    	// echo "<pre>";
	     //    print_r($query_clearig_member_profile);
	     //    echo "</pre>";
	     //    echo "<br>";
	     //    exit();
	   ...
	   //      exit();
	    ...
	    $query_update_registrasion_login = "UPDATE SKD.RegistrationLoginMember SET flaguser = '202' WHERE username = '".$_SESSION['val']['username']."'";
