...
class m_tpa_01_query_insert_buyer extends CI_Model {
	...
	public function ClearingMemberTable($Code,$calon,$email,$notlp,$jenis_anggota,$akte_pendiri,$akte_perubahan,$domisili_perusahaan,$npwp_perusahaan,$perizinan_instansi,$member_stat,$no_acc,$acc_name,$bank_name){
