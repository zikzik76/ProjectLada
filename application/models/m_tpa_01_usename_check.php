...
class m_tpa_01_usename_check extends CI_Model {
	...
	public function get_data($a){
        ...
        $a = $db->escape($a);
        $query = "SELECT * FROM SKD.RegistrationLoginMember where username = '".$a."'";
...
/* End of file m_tpa_01_usenamr_check.php */
/* Location: ./application/models/m_tpa_01_usenamr_check.php */